...
import qiang.facerecognition.FaceClassifier.Recognition;
...
public class MultiBoxTracker {
    ...
    private void processResults(
        ...
        for (final Recognition result : results) {
            ...
            screenRects.add(new Pair<>(result.getCmpResult(), detectionScreenRect));
            ...
            rectsToTrack.add(new Pair<>(result.getCmpResult(), result));
        }
