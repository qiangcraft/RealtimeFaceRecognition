...
public class MainActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        trainSnackbar = Snackbar.make(container, "Updating data...", Snackbar.LENGTH_INDEFINITE);
        ...
        AlertDialog editDialog = new AlertDialog.Builder(MainActivity.this)
                ...
                .setPositiveButton(getString(R.string.dialog_btn_confirm_text), (dialogInterface, i) -> {
                    if(!editText.getText().toString().trim().equals("")) {
                        ...
                        editText.setText("");
                        if(faceClassifier.ifNoSameName(person_name)) {
        ...
        button.setOnClickListener(view ->
                new AlertDialog.Builder(this)
                        ...
                        .setItems(faceClassifier.getShowList(), (dialogInterface, i) -> {
                            if (i == 0) {
                                editDialog.show();
                            }
                            else {
                                new AlertDialog.Builder(this)
                                        ...
                                        .setPositiveButton(getString(R.string.dialog_btn_confirm_text)
                                                , (dialog, which) -> {
                                                    ...
                                                    faceClassifier.getPersonNames().remove(faceClassifier.getShowList()[i]);
...
//                                performFileSearch(i - 1);
    ...
    void init() {
        ...
        try {
            faceClassifier = FaceClassifier.getInstance(getAssets(), FACE_SIZE, FACE_SIZE);
        } catch (Exception e) {
    ...
    protected void processImage() {
        ...
        runInBackground(
                () -> {
                    ...
                    List<FaceClassifier.Recognition> mappedRecognitions = null;
                    try {
                        mappedRecognitions = faceClassifier.recognizeImage(croppedBitmap, cropToFrameTransform);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK) {
            ...
            new Thread(() -> {
                try {
                    faceClassifier.updateData(person_name, getContentResolver(), uris);
                } catch (Exception e) {
